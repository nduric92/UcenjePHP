      ...
      <div class="grid-x grid-padding-x">
        <div class="large-12 cell">
          ...
          <?php 
            ...
            $spajanjeosoba = $veza->prepare('select * from osoba');

            $spajanjeosoba->execute();

        
            $rs = $spajanjeosoba->fetchAll();

            foreach($rs as $red):
              ?>
              <h6><?=$red->ime ?>, <?=$red->prezime ?>, <?=$red->email ?></h1>
              <?php
            endforeach;
