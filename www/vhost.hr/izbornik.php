  ...
  <div class="top-bar-left">
    <ul class="dropdown menu" data-dropdown-menu>
      ...
      <li class="has-submenu">
        ...
        <ul class="submenu menu vertical" data-submenu>
          ...
          <li>
            ...
            <ul class="submenu menu vertical" data-submenu>
              ...
              <li><a target="_blank" href="whilepelja.php">while petlja</a></li>
              <li><a target="_blank" href="dowhilepelja.php">do while petlja</a></li>
              <li><a target="_blank" href="foreachpelja.php">for each petlja</a></li>
            </ul>
          </li>
        ...
        <li>
          <a href="#">Ucenje vhost</a>
          <ul class="submenu menu vertical" data-submenu>
            <li><a href="forma.php">Moja verzija forme za upis dva broja</a></li>
            <li><a href="radio.php">odabir drugi nacin radio</a></li>
            <li><a href="checkbox.php">checkbox treci nacin</a></li>
            <li><a href="gradovi.php">Gradovi</a></li>
            <li><a href="textarea.php">text area</a></li>
          </ul>
        </li>
